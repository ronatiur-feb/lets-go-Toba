...
font-size: 16px;"> <a href="../logout.php" class="btn btn-success square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<!-- <li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="data_tujuan.php"><i class="fa fa-exchange fa-3x"></i> Daftar Tujuan</a>
                    </li>
						   <li  >
     ...
     <div class="container">	
		<div class="row">
			<div class="col-md-10">
				<h3>Daftar Tujuan</h3>
				<a href="tambah_tujuan.php"><button class="btn btn-default"><span class="glyphicon glyphicon-plus"></span>Tambah Tujuan</button></a><br><br>
				<br>
				<table class="table table-hover">
					...
					?>
					<tr>
						<td><?=$items['id_tujuan'];?></td>
						<td><?=$items['kecamatan'];?></td>
						<td>Rp. <?=$items['harga'];?></td>
						<td>
						<a href="perbarui_tujuan.php?id_tujuan=<?=$items['id_tujuan']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-wrench"></span></button></a>
						<a href="hapus_tujuan.php?id_tujuan=<?=$items['id_tujuan']?>"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a>
						</td>
					</tr>
				<?php } ?>
				</table>
