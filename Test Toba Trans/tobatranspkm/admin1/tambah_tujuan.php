...
font-size: 16px;"> <a href="../logout.php" class="btn btn-success square-btn-adjust">Logout</a> </div>
	...
	<div class="row">
		<div class="col-sm-8">
			<h3>Tambah tujuan</h3>
			<form action="tambah_tujuan_process.php" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label>Kecamatan</label>	
				<input type="text" class="form-control" name="namaKecamatan" required>
			</div>
			
			<div class="form-group">
				<label>Harga</label>	
				<input type="number" class="form-control" name="hargaMobil" required>
			</div>
			
			<button class="btn btn-primary" name="tambahTujuan" type="submit">Tambahkan</button>
			</form>
		</div>
	</div>
</div>
