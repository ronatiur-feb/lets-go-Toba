...
font-size: 16px;"> <a href="../logout.php" class="btn btn-success square-btn-adjust">Logout</a> </div>
     ...
     <div class="container">
		<div class="row">
			<div class="col-sm-8">
				<h3>Penambahan Galeri</h3>
				<form action="tambah_galeri_process.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" name="lokasi" class="form-control" required><br>
				...
				<button class="btn btn-primary" name="tambahGaleri" type="submit">Tambahkan</button>
				</form>
			</div>
		</div>
	</div>
