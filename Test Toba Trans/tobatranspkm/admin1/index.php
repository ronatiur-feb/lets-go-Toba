    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="C:\xampp\htdocs\Project Pkm toba trans\tobatranspkm\admin1\assets\find_user.png" width="220"></a> 
            </div>
                     ...
                     <div class="col-md-6">           
                        <div class="panel panel-back noti-box">
                            ...
                            <div class="text-box" >
                                ...
                                <p class="text-muted">Jumlah Supir</p>
                            </div>
                        </div>
                     </div>
