    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="index.php"><img src="../admin1/image/logo.png" width="100"></a>
            </div>
			...
			<div class="col-md-12">
				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td>
							<?php echo '<img id="gambarGaleri" src="..admin1/image/galeri/'.$items['gambar'].'"alt="Avatar">' ?>
						</td>
						<td><?=$items['tanggal'];?> </td>
						<td>
